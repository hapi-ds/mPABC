...
class TestSourceURLConstruction:
    ...
    **Validates: Requirements 1.1**
    ...
    def test_url_contains_base_endpoint(
        ...
        with patch(
            "business_coach.agents.prior_art_search.urlopen",
            return_value=_make_mock_response(),
        ) as mock_urlopen, patch(
            "business_coach.agents.prior_art_search._get_request_delay", return_value=0,
        ):
            try:
...
from business_coach.exceptions import SourceUnavailableError
