...
class TestRuntimePathResolution:
    ...
    **Validates: Requirements 4.1, 4.2, 4.3**
    ...
    def test_source_mode_returns_project_root(self, data: st.DataObject) -> None:
        ...
        # config.py lives at src/business_coach/config.py
        ...
        config_expected = Path(
            __import__("business_coach.config", fromlist=["config"]).__file__
        ).resolve().parents[2]
...
class TestCommandConstructionInvariant:
    ...
    entry point src/business_coach/main.py, and --output-dir=<configured_dir>.
    ...
    **Validates: Requirements 1.1, 1.3**
    ...
    def test_command_always_contains_standalone_entrypoint_outputdir(
        ...
        assert "src/business_coach/main.py" in cmd
