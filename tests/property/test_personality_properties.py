...
from business_coach.agents.personality import (
...
class TestDSPyPrefixPrepending:
    ...
    **Validates: Requirements 4.1**
    ...
    def test_forward_prepends_prefix_to_primary_input(
        ...
        from business_coach.dspy_modules.modules import DraftClaimsModule
...
class TestInvalidModeFallbackInDSPyModules:
    ...
    **Validates: Requirements 4.4**
    ...
    def test_invalid_mode_logs_warning(
        ...
        logger = logging.getLogger("business_coach.agents.personality")
