...
class TestSourceFiltering:
    ...
    **Validates: Requirements 4.2, 4.3**
    ...
    def test_source_selection_filters(self, selected: list[str]) -> None:
        ...
        from business_coach.agents.prior_art_search import (
            _SOURCE_REGISTRY,
        ...
        with patch(
            "business_coach.agents.prior_art_search._query_source",
    ...
    **Validates: Requirements 7.5**
    ...
    def test_disclosure_pass_through(
        ...
        with (
            ...
            patch(
                "business_coach.agents.disclosure.StructureDisclosureModule"
            ) as mock_structure,
        ):
...
class TestDeduplication:
    ...
    **Validates: Requirements 6.1, 6.2**
    ...
    def test_dedup_matches_expected(
        ...
        from business_coach.gui.research_panel import _is_duplicate
...
class TestDisclosureDictConstruction:
    ...
    **Validates: Requirements 1.6**
    ...
    def test_disclosure_dict_construction(
        ...
        from business_coach.gui.research_panel import _build_disclosure_dict
...
class TestRAGFullTextInclusion:
    ...
    **Validates: Requirements 5.3**
    ...
    def test_rag_text_contains_both_abstract_and_full_text(
        ...
        from business_coach.gui.research_panel import _build_rag_document_text
