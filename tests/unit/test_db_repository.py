...
from business_coach.db.models import PatentRecord, Topic
...
class TestInventionDisclosureRepository:
    ...
    def test_upsert_creates_disclosure_and_returns_id(
        ...
        from business_coach.db.repository import InventionDisclosureRepository
...
class TestSourcePreferenceRepository:
    ...
    def test_save_and_get_preferences(
        ...
        from business_coach.db.repository import SourcePreferenceRepository
