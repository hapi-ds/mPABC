...
from business_coach.export.docx_exporter import DOCXExporter, validate_export
...
class TestDOCXExporterWorkflowSteps:
    ...
    def test_export_all_workflow_steps(self, tmp_path: Path) -> None:
        ...
        from business_coach.export.docx_exporter import WORKFLOW_STEP_ORDER, STEP_DISPLAY_NAMES
