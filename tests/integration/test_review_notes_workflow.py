...
from business_coach.agents.claims_drafting import claims_drafting_node
from business_coach.agents.consistency_review import consistency_review_node
from business_coach.agents.description_drafting import description_drafting_node
from business_coach.agents.disclosure_summary import disclosure_summary_node
from business_coach.agents.legal_clarification import legal_clarification_node
from business_coach.agents.market_potential import market_potential_node
from business_coach.agents.novelty_analysis import novelty_analysis_node
...
class TestAgentNodesWithReviewNotesContinueMode:
    ...
    @patch("business_coach.agents.claims_drafting.DraftClaimsModule")
    ...
    @patch("business_coach.agents.novelty_analysis.NoveltyAnalysisModule")
    ...
    @patch("business_coach.agents.consistency_review.ReviewConsistencyModule")
    ...
    @patch("business_coach.agents.market_potential.MarketPotentialModule")
    ...
    @patch("business_coach.agents.legal_clarification.LegalClarificationModule")
    ...
    @patch("business_coach.agents.disclosure_summary.DisclosureSummaryModule")
...
class TestDescriptionDraftingAccumulatesNotes:
    ...
    @patch("business_coach.agents.description_drafting.DraftDescriptionModule")
    @patch("business_coach.agents.description_drafting.RefineClaimsModule")
...
class TestReviewNotesEndToEndFlow:
    ...
    def test_save_and_load_review_notes_round_trip(self, in_memory_db):
        ...
        from business_coach.db.repository import WorkflowStepRepository
...
class TestBackwardCompatibility:
    ...
    def test_migration_adds_review_notes_column_to_existing_table(self, in_memory_db):
        ...
        # Run the migration
        from business_coach.db.schema import _migrate_workflow_steps_review_notes
