...
class TestDisclosureNode:
    ...
    @patch("business_coach.agents.disclosure.StructureDisclosureModule")
    @patch("business_coach.agents.disclosure.InterviewQuestionModule")
...
class TestPriorArtSearchNode:
    ...
    @patch("business_coach.agents.prior_art_search._query_source")
...
class TestNoveltyAnalysisNode:
    ...
    def test_returns_analysis_and_step(self):
        ...
        with patch("business_coach.agents.novelty_analysis.NoveltyAnalysisModule") as mock_cls:
