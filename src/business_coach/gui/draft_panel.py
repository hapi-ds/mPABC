...
from business_coach.agents.state import PatentWorkflowState
from business_coach.agents.personality import AGENT_PERSONALITY_DEFAULTS
    ...
    with container:
        ...
        async def _run_workflow_from(start_key: str, *, force_fresh: bool = False) -> None:
            ...
            try:
                ...
                from business_coach.exceptions import LLMConnectionError
        ...
        async def _rerun_single_step(step_key: str) -> None:
            ...
            try:
                ...
                from business_coach.agents.graph import _local_prior_art_summary_node
        ...
        def _on_export() -> None:
            ...
            try:
                template_dir = Path("src/business_coach/export/templates")
                template_name = None
                try:
                ...
                from business_coach.gui.research_panel import _SOURCE_URLS
                if conn is not None:
                    try:
                        session_repo = ResearchSessionRepository(conn)
                        patent_repo = PatentRepository(conn)
                ...
                if conn is not None:
                    try:
                        from business_coach.db.repository import LocalDocumentRepository
