...
def create_research_panel(
    ...
    with container:
        ...
        async def _on_suggest_terms() -> None:
            ...
            try:
                from business_coach.dspy_modules.modules import SuggestSearchTermsModule
                ...
                if conn is not None:
                    try:
                        ...
                        for rec in new_results:
                            ...
                            if is_paper:
                                from business_coach.db.models import ScientificPaperRecord as SPR
                                paper_record = SPR(
                                ...
                                from business_coach.db.models import PatentRecord as PR
                                patent_record = PR(
