...
class SearchSectionGenerator(dspy.Signature):
    ...
    sections_json = dspy.OutputField(desc="A JSON list of objects, each with 'section_name' (e.g. 'Competitors', 'Customers', 'Finances') and 'search_query' (the exact query string to use in DuckDuckGo). Max 6 sections.")
